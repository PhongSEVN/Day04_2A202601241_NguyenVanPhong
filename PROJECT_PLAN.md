...
## 🚀 4. QUICK START CHECKLIST (CẦN CHUẨN BỊ TRƯỚC GIỜ LAB)
...
## 📋 5. CHECKLIST SẢN PHẨM CẦN GIAO NỘP
...
## 🚨 6. FALLBACK PLANS (NẾU CÓ VẤN ĐỀ)
...
## 📞 7. COMMUNICATION PROTOCOL (TRONG LAB)

**Leader (Phong)** gọi thời gian:
- **XX:00** → "GO" (mỗi phase mới bắt đầu)
- **XX:05, XX:10, XX:15** → Check-in "How's it going?"
- **XX:59** → "1 phút nữa"
- **XX:60** → "Dừng lại! Handoff time"

**Mỗi người báo xong:**
- Nói thành tiếng: "Tôi xong [task], output là [file]. Sẵn sàng cho [next phase]"
- Slack/Discord: Post file link + checkmark emoji ✅
